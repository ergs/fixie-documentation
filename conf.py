...
project = u'fixie'
copyright = u'2018, Anthony Scopatz'
...
# of the sidebar.
html_logo = '_static/fixie-logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '_static/fixie-logo.ico'
...
latex_documents = [
  ('index', 'fixie.tex', u'fixie documentation',
...
USAGE = """Fixie Command Line Usage
========================
